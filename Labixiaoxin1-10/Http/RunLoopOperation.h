...
enum RunLoopOperationState {
    kRunLoopOperationStateInited, 
    kRunLoopOperationStateExecuting, 
    kRunLoopOperationStateFinished
};

typedef enum RunLoopOperationState RunLoopOperationState;

@interface RunLoopOperation : NSOperation {
    RunLoopOperationState   _state;
...
@property (assign, readonly ) RunLoopOperationState    state;
...
@interface RunLoopOperation (SubClassSupport)
