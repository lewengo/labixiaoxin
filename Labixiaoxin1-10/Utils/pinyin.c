...
"xxjqwjeqxnchetlzalyyyszzpnkyzcptlshtzcfycyxyljxdcjqagyslcllyyysslqqqnldxzsccscadycjysfsgbfrsszqsbxjp"
...
"qlmcmmsshmybhbnkkbhrsxxjmxmdznnpklbbrhgghfchgmnklltsyyycqlcskymyehywxnxqywbawykqldnntndkhqcgdqktgpkx"
...
char pinyinFirstLetter(unsigned short hanzi)
{
	...
	{
        int index2 = hanzi - UPPER_START;
        if (index2 >= 0 && index2 <= UPPER_COUNT)
        {
            return hanzi;
        }
        
        int index3 = hanzi - LOWER_START;
        if (index3 >= 0 && index3 <= LOWER_COUNT)
        {
            return hanzi;
        }
