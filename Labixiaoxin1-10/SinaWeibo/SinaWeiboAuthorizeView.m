 ...
 navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if ([url hasPrefix:appRedirectURI] || [url hasPrefix:siteRedirectURI]) {
        NSString *error_code = [SinaWeiboRequest getParamValueFromUrl:url
        ...
        if (error_code) {
            ...
            [self hide];
            [delegate authorizeView:self
               didFailWithErrorInfo:errorInfo];
        } else {
